...
def create_key(salt_path: str) -> bytes:
...
def encrypt(plaintext: str, salt_path: str) -> str | None:
    ...
    return binascii.hexlify(bytearray(iv) + bytearray(encrypted)).decode('ascii')


def decrypt(ciphertext: str, salt_path: str) -> str | None:
